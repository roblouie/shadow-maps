...
void main()
{
  ...
  float shadowAdjuster = (positionFromLightPovInTexture.z - 0.7) < texture(shadowMap, vec3(positionFromLightPovInTexture.xy, positionFromLightPovInTexture.z)) ? 1.0 : 0.5;
  fragColor = shadowAdjuster * vColor;
}`;
