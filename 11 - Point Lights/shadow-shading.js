...
void main()
{
  ...
  float diffuse = max(0.0, dot(direction, normalize(vNormal)));
...
const lightDirectionLoc = gl.getUniformLocation(program,'uLightPosition');
gl.uniform3fv(lightDirectionLoc, new Float32Array([lightPosition.x, lightPosition.y, lightPosition.z]));


// Set Camera MVP Matrix
const cameraPosition = new DOMPoint(0.8, 1, 0.8);
